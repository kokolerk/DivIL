...
class cNCEContrast(torch.nn.Module):
    '''
    class condition infoNCE
    postive example: augmented sample
    negtive examples: same class sample

    '''
    def __init__(self, loss: Loss, mode: str, intraview_negs: bool = False, **kwargs):
        super(cNCEContrast, self).__init__()
