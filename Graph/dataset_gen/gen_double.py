...
if not os.path.exists(f'../data/dSPMotif-{global_b}/'):
    os.mkdir(f'../data/dSPMotif-{global_b}/')
if not os.path.exists(f'../data/dSPMotif-{global_b}/raw'):
    os.mkdir(f'../data/dSPMotif-{global_b}/raw')
np.save(f'../data/dSPMotif-{global_b}/raw/train.npy',
...
# print(np.mean(n_mean), np.mean(e_mean))
# print(len(ground_truth_list))
np.save(f'../data/dSPMotif-{global_b}/raw/val.npy',
        (edge_index_list, label_list, base_list,ground_truth_list, role_id_list, pos_list, motif_id_list))
...
print(motif_id_list[-10:])
np.save(f'../data/dSPMotif-{global_b}/raw/test.npy',
        (edge_index_list, label_list, base_list,ground_truth_list, role_id_list, pos_list, motif_id_list))
